...
(function() {
  var ChainLink, ParsedKeys, SigChain, a_json_parse, athrow, iced, kbpgp, make_esc, proofs, __iced_k, __iced_k_noop, _ref;
  ...
  ChainLink = (function() {
    ChainLink.parse = function(_arg, cb) {
      var ctime_seconds, esc, key_manager, kid, parsed_keys, payload, payload_buffer, payload_hash, payload_json, sig_blob, sig_buffer, sig_id, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            key_manager.make_sig_eng().unbox(sig_blob.sig, esc(__iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype._check_key_is_valid = function(_arg, cb) {
      ...
      if (!(link.kid in this._valid_sibkeys)) {
        err = new Error("not a valid sibkey: " + link.kid + " valid sibkeys: " + (JSON.stringify(this._valid_sibkeys)));
