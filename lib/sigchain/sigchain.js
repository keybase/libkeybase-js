...
(function() {
  var ChainLink, E, ParsedKeys, SIG_ID_SUFFIX, SigChain, UID_LEN, a_json_parse, athrow, current_time_seconds, iced, ie, kbpgp, make_esc, proofs, __iced_k, __iced_k_noop, _ref;
  ...
  ChainLink = (function() {
    ...
    ChainLink._check_payload_format = function(_arg, cb) {
          ...
          if (uid.length !== UID_LEN) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/home/jacko/libkeybase-js/src/sigchain/sigchain.iced",
                funcname: "ChainLink._check_payload_format"
              });
