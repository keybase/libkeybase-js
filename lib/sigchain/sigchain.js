...
(function() {
  ...
  exports.SigChain = SigChain = (function() {
    ...
    function SigChain(_arg) {
      var eldest_kid, etime_seconds, kid, km, parsed_keys, uid, username, _ref1;
      ...
      for (kid in _ref1) {
        km = _ref1[kid];
        if (km.get_type() === 'pgp' && (km.primary.lifespan.expire_in != null)) {
