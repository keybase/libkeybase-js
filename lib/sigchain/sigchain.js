...
(function() {
  var ChainLink, ParsedKeys, SigChain, a_json_parse, athrow, error, iced, kbpgp, make_esc, proofs, __iced_k, __iced_k_noop, _ref;
  ...
  exports.SigChain = SigChain = (function() {
    ...
    SigChain.prototype._check_key_is_valid = function(_arg, cb) {
      ...
      if (!(link.kid in this._valid_sibkeys)) {
        err = error({
          type: "INVALID_SUBKEY",
          msg: "not a valid sibkey: " + link.kid + " valid sibkeys: " + (JSON.stringify(this._valid_sibkeys))
        });
