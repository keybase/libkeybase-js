...
(function() {
  var ChainLink, E, ParsedKeys, SIG_ID_SUFFIX, SigChain, UID_LEN, a_json_parse, athrow, check_link_payload_format, current_time_seconds, iced, ie, kbpgp, make_esc, proofs, __iced_k, __iced_k_noop, _ref;
  ...
  ChainLink = (function() {
    ...
    ChainLink._unbox_payload = function(_arg, cb) {
      var ctime_seconds, err, esc, key_manager, kid, parsed_keys, payload, payload_buffer, payload_hash, payload_json, sig_blob, sig_body, sig_cache, sig_eng, sig_id, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      sig_blob = _arg.sig_blob, parsed_keys = _arg.parsed_keys, sig_cache = _arg.sig_cache;
  ...
  exports.SigChain = SigChain = (function() {
    ...
    function SigChain(_arg) {
      ...
      this._subkeys_to_etime_seconds = {};
      this._valid_subkeys = {};
    ...
    SigChain.prototype.get_sibkeys = function(_arg) {
      ...
      return (function() {
        ...
        for (kid in this._valid_sibkeys) {
          if (this._sibkeys_to_etime_seconds[kid] > now) {
            _results.push(kid);
          }
        }
        return _results;
    ...
    SigChain.prototype.get_subkeys = function(_arg) {
      ...
      return (function() {
        ...
        for (kid in this._valid_subkeys) {
          if (this._subkeys_to_etime_seconds[kid] > now) {
            _results.push(kid);
          }
        }
        return _results;
    ...
    SigChain.prototype._delegate_keys = function(_arg, cb) {
      ...
      if (link.subkey_delegation != null) {
        ...
        this._subkeys_to_etime_seconds[link.subkey_delegation] = link.etime_seconds;
      }
      return cb();
    };
