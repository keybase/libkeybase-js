...
(function() {
  ...
  sha256 = function(s) {
    return (new hash.SHA256).bufhash(Buffer.from(s, 'utf8')).toString('hex');
  };

  sha512 = function(s) {
    return (new hash.SHA512).bufhash(Buffer.from(s, 'utf8')).toString('hex');
  };
  ...
  BaseTree = (function(_super) {
    ...
    BaseTree.prototype.lookup_root = function(_arg, cb) {
      var txinfo;
      txinfo = _arg.txinfo;
