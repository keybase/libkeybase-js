...
(function() {
  var BaseTree, C, LegacyUidNameTree, MainTree, PathChecker, a_json_parse, hash, iced, make_esc, merkle, pathcheck, sha256, sha512, __iced_k, __iced_k_noop,
  ...
  PathChecker = (function() {
    ...
    PathChecker.prototype._verify_path = function(_arg, cb) {
      var esc, leaf, nodes, root, tree, uid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      uid = _arg.uid;
