...
(function() {
  var BaseTree, C, LegacyUidNameTree, MainTree, PathChecker, hash, iced, make_esc, merkle, __iced_k, __iced_k_noop,
  ...
  exports.pathcheck = function(_arg, cb) {
  ...
  PathChecker = (function() {
    ...
    PathChecker.prototype._verify_sig = function(cb) {
      var err, sigeng, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          sigeng.unbox(_this.server_reply.root.sig, __iced_deferrals.defer({
            assign_fn: (function(__slot_1) {
              return function() {
                err = arguments[0];
                return __slot_1._signed_payload = arguments[1];
              };
            })(_this),
            lineno: 43
          }));
    ...
    PathChecker.prototype._verify_path = function(_arg, cb) {
      var err, esc, leaf, nodes, root, tree, uid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      uid = _arg.uid;
      esc = make_esc(cb, "PathChecker::_verify_username_legacy");
      root = this._signed_payload.body.root;
      nodes = this._extract_nodes(this._signed_payload.path);
    ...
    PathChecker.prototype._verify_username_legacy = function(_arg, cb) {
      var leaf, nodes, root, tree, uid, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      uid = _arg.uid, username = _arg.username;
      root = this._signed_payload.body.legacy_uid_root;
      nodes = this._extract_nodes(this._signed_payload.uid_proof_path);
      tree = new MainTree({
        root: root,
        nodes: nodes
      });
